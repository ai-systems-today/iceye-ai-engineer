...
Phase 11 is partial because the implementation has been validated and the delivery zip exists, but full PDF completion still depends on phase 9.
...
- The current delivery archive is [iceye-ai-engineer-current-state.zip](iceye-ai-engineer-current-state.zip).